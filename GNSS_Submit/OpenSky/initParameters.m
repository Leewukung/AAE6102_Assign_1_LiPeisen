...
file.fileRoute      = ['D:\GNSS\',file.fileName,'.bin'];  
% file.fileName       = 'Urban';  
% file.fileRoute      = ['D:\GNSS\',file.fileName,'.DAT'];

file.skip        	= 5000; % in unit of ms
% solu.iniPos	= [22.292934/180 * pi, 114.169688/180 * pi, 10]; % Ground truth location 
solu.iniPos = [22.3198722/180 * pi, 114.209101777778/180 * pi, 10]; % Ground truth location for Urban
...
%% Signal parameters
% signal.IF               = 1580e6-1575.42e6; % unit: Hz 
signal.IF               = 0; % unit: Hz 
